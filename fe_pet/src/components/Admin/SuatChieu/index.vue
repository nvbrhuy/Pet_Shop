            ...
            <div class="card radius-10 border-top border-0 border-3 border-info">
                ...
                <div class="card-body table-responsive">
                    <div class="input-group mb-3">
                        ...
                        <button @click="timKiem()" class="btn btn-success input-group-text" style="width: 150px;">Tìm kiếm</button>
                    </div>
...
export default {
    ...
    methods: {
        timKiem() {
            axios.post('http://127.0.0.1:8000/api/admin/suat-chieu/tim-kiem', this.tim_kiem)
                .then((res) => {
