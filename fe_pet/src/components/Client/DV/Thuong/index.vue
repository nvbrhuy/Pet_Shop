    ...
    <div id="carouselExampleAutoplaying" class="carousel slide" data-bs-ride="carousel">
         <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="https://vethospital.vnua.edu.vn/wp-content/uploads/2024/06/IMG_7725.jpeg" class="d-block w-100"
                    style="width: 100%; height: 250px; object-fit: cover;">
            </div>
            <div class="carousel-item ">
                <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR8fCoMY5VLkrE1aRv2JsIez_UKUXHxdlGurg&s" class="d-block w-100"
                    style="width: 100%; height: 250px; object-fit: cover;">
            </div>
            <div class="carousel-item ">
                <img src="https://play-lh.googleusercontent.com/erlgJ0rK7PE89P2rnW-KfwvfpTt6Ghv6qgIzflAssk-V8zliG3L4nIYGWfWUJG4JyDM=w1080"
    ...
    <div class="container mt-3">
        <div class="row">
            <div class="text-center mb-3">
                <h4 class="text-uppercase fs-3 text-dark">Dịch Vụ Thường</h4>
            </div>
